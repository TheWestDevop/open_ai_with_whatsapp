defmodule AiWithWhatsappWeb.UserController do
  use AiWithWhatsappWeb, :controller

  alias AiWithWhatsapp.Admin
  alias AiWithWhatsapp.Admin.User
  alias WhatsAppClient.VerifyToken, as: VerifyCommand
  alias WhatsAppClient.MessageChecker, as: MessageCheckerCommand

  action_fallback AiWithWhatsappWeb.FallbackController
